...
import com.daralmathour.altaefhessan.Activities.MainOActivity;
...
public class QiblaCompassManager implements SensorEventListener,
    ...
    private final MainOActivity qiblaActivity;
    ...
    public QiblaCompassManager(MainOActivity qiblaActivity) {
