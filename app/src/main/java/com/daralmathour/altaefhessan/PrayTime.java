 ...
 * Created by codelab on 9/3/2018.
 */

//--------------------- Copyright Block ----------------------
/*

com.daralmathour.altaefhessan.PrayTime.java: Prayer Times Calculator (ver 1.0)
...
public class PrayTime {
    ...
    public String GetTimesForPray()
    {
        double latitude = 21.423524;
        double longitude = 39.825223;
        double timezone = 3;
        ...
        for (int i = 0; i < prayerTimes.size(); i++) {
            ...
            result += prayerNames.get(i) + " - " + prayerTimes.get(i);
        }
        return  result;
    }
